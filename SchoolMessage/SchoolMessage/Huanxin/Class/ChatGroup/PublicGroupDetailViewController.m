...
- (UIView *)headerView
{
    if (_headerView == nil) {
        ...
        imageView = [[UIImageView alloc] initWithFrame:CGRectMake(20, 20, 50, 50)];
...
- (void)reloadSubviewsInfo
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [[RosterManager sharedInstance] getGroupInfoByChatter:weakSelf.group callBack:^(BOOL succeed, GroupInfo *groupInfo) {
            [weakSelf.imageView setImageWithURL:[NSURL URLWithString:groupInfo.groupHeadPhotoUrl] placeholderImage:[UIImage imageNamed:@"groupPublicHeader"]];
        }];
