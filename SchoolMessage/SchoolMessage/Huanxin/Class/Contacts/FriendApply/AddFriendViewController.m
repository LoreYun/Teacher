...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[self.dataSource objectAtIndex:indexPath.row] valueForKey:@"NickName"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *buddyName = [[self.dataSource objectAtIndex:indexPath.row] valueForKey:@"Account"];
    NSString *nickName = [[self.dataSource objectAtIndex:indexPath.row] valueForKey:@"NickName"];
