...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    __weak BlackListViewController * con = self;
    NSString *username = [[self.dataSource objectAtIndex:indexPath.section] objectAtIndex:indexPath.row];
    FriendInfo *info = [self.friendDic objectForKey:username];
    if (info) {
        [cell.imageView setImageWithURL:[NSURL URLWithString:info.headPhotoUrl] placeholderImage:[UtilManager imageNamed:@"chatListCellHead.png"]];
        cell.textLabel.text = info.nickName;
    }else{
        cell.imageView.image = [UtilManager imageNamed:@"chatListCellHead.png"];
        cell.textLabel.text = username;
        [[RosterManager sharedInstance] getFriendInfoByChatter:username callBack:^(BOOL succeed, FriendInfo *firendInfo) {
            [con.friendDic setObject:firendInfo forKey:username];
