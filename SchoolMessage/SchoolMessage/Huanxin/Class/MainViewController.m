...
- (void)setupSubviews
{
    self.tabBar.backgroundImage = [UtilManager createImageWithColor:[UIColor whiteColor]];//[[UIImage imageNamed:@"tabbarBackground"] stretchableImageWithLeftCapWidth:25 topCapHeight:25];
    self.tabBar.selectionIndicatorImage = [[UtilManager createImageWithColor:[UtilManager getColorWithHexString:@"18b4ed"]] stretchableImageWithLeftCapWidth:5 topCapHeight:5];//[[UIImage imageNamed:@"tabbarSelectBg"] stretchableImageWithLeftCapWidth:25 topCapHeight:25];
    
    _chatListVC = [[ChatListViewController alloc] init];
    _chatListVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"会话" image:[[UIImage imageNamed:@"tabbar_chatsHL"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"tabbar_chats"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    
    
//    [_chatListVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"tabbar_chats"]
//                         withFinishedUnselectedImage:[UIImage imageNamed:@"tabbar_chatsHL"]];
    ...
    _contactsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"友群" image:[[UIImage imageNamed:@"tabbar_contactsHL"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"tabbar_contacts"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    _contactsVC.tabBarItem.tag = 1;
    [self unSelectedTapTabBarItems:_contactsVC.tabBarItem];
    [self selectedTapTabBarItems:_contactsVC.tabBarItem];
    
    _settingsVC = [[SettingsViewController alloc] init];
    _settingsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"设置" image:[[UIImage imageNamed:@"tabbar_settingHL"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"tabbar_setting"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
...
-(void)unSelectedTapTabBarItems:(UITabBarItem *)tabBarItem
{
    [tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                        [UIFont systemFontOfSize:14], NSFontAttributeName,[UtilManager getColorWithHexString:@"#18b4ed"],NSForegroundColorAttributeName,
...
//tong ji weichuli hao you qing qiu
...
- (void)willAutoReconnect{
    ...
    _contactsVC.reContectedFlag = YES;
}

- (void)didAutoReconnectFinishedWithError:(NSError *)error{
    [self hideHud];
    _contactsVC.reContectedFlag = NO;
    if (error) {
