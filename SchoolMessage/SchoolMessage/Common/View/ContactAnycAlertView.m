...
@interface ContactAnycAlertView ()
...
@implementation ContactAnycAlertView
...
{
    [self hidden];
    if (self.delegate && [self.delegate respondsToSelector:@selector(ContactAnycAlertViewDownload)]) {
        [self.delegate ContactAnycAlertViewDownload];
    }
}
...
{
    [self hidden];
    if (self.delegate && [self.delegate respondsToSelector:@selector(ContactAnycAlertViewUpload)]) {
        [self.delegate ContactAnycAlertViewUpload];
    }
}
