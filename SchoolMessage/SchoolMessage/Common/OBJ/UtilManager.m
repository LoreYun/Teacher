...
+(NSString *)speMd5:(NSString *)content
{
    ...
    for (int i = 0;i<content.length;i++) {
        ...
        NSString *md5temp = [[__MD5(temp) uppercaseString] substringWithRange:NSMakeRange(c, 1)];
        result = [result stringByAppendingString:md5temp];
        c++;
        if (c>31) {
            c=0;
        }
    ...
    return  [[UtilManager md5:result] uppercaseString];
}
